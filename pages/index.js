...
const addImageFormElement = addImageModal.querySelector('.modal__form');
...
const cardTitleInput = addImageFormElement.querySelector('#add-image-title-input');
const cardUrlInput = addImageFormElement.querySelector('#add-image-url-input');
